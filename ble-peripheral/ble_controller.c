...
//    if (!p_controller->is_notification_supported) {
//        return;
//    }
//
//    ble_gatts_evt_write_t *p_evt_write = &p_ble_evt->evt.gatts_evt.params.write;
//
//    if (p_evt_write->handle == p_controller->controller_io_char_handles.cccd_handle &&
//        p_evt_write->len > 0 &&
//        p_controller->controller_write_handler != NULL) {
//
//        air_monitor_evt_t evt;
//
//        if (ble_srv_is_notification_enabled(p_evt_write->data)) {
//            evt.evt_type = UWE_SENSE_EVT_NOTIFICATION_ENABLED;
//        } else {
//            evt.evt_type = UWE_SENSE_EVT_NOTIFICATION_DISABLED;
//        }
//
...
//    }
    ...
    ble_gatts_evt_write_t *p_evt_write = &p_ble_evt->evt.gatts_evt.params.write;
    p_controller->controller_write_handler(p_controller, p_evt_write->data[0]);
}
...
//    char_md.char_props.write_wo_resp = 1;
    ...
    //BLE_UUID_BLE_ASSIGN(ble_uuid, CONTROLLER_IO_UUID_CHAR);
...
uint32_t ble_controller_init(
    ...
    //ble_uuid.type = p_cservice->uuid_type;
    //ble_uuid.uuid = BLE_UWE_SENSE_BUTTON_SERVICE;

    // Add service
    BLE_UUID_BLE_ASSIGN(ble_uuid, BLE_UWE_SENSE_BUTTON_SERVICE);
