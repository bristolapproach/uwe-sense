...
#define BLE_UWE_SENSE_UUID_BASE_REV { 0x33, 0x2f, 0x08, 0x7b, 0xb5, 0x1c, 0xd7, 0xae, 0xd3, 0x44, 0x3f, 0x08, 0x0b, 0xa8, 0x43, 0xa9}

#define BLE_UWE_SENSE_UUID_BASE { 0xA9, 0x43, 0xA8, 0x0B, 0x08, 0x3F, 0x44, 0xD3, 0xAE, 0xD7, 0x1C, 0xB5, 0x7B, 0x08, 0x2F, 0x33 }

#define BLE_UWE_SENSE_BUTTON_SERVICE 0xa80b
...
typedef enum {
    UWE_SENSE_EVT_NOTIFICATION_ENABLED,                             /**< sensor value notification enabled event. */
    UWE_SENSE_EVT_NOTIFICATION_DISABLED                             /**< sensor value notification disabled event. */
} use_sense_evt_type_t;
...
struct ble_controller_s
{
    ...
    bool is_notification_supported;      /**< TRUE if notification of sensor value is supported. */
};
